...
__C.DATA.TRAIN_MAP_FILE = "small.df"
__C.DATA.TRAIN_ROI_FILE = "small.df"
__C.DATA.TEST_MAP_FILE = "small.df"
__C.DATA.TEST_ROI_FILE = "small.df"
__C.DATA.NUM_TRAIN_IMAGES = 180
__C.DATA.NUM_TEST_IMAGES = 28
